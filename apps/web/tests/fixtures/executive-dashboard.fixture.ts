import type { ExecutiveDashboardResponse } from "@/modules/executive-overview/executive-dashboard/types/executive-dashboard.types";
...
export function getExecutiveDashboardMock(): ExecutiveDashboardResponse {
  ...
  return {
    ...
    marketCondition: {
      ...
      marketRegime: "Range G�� Breakout Watch",
