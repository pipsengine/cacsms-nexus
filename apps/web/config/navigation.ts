...
const definitions: SectionDefinition[] = [
  ...
  },
  {
    ...
    description: "MT5 and broker connectivity placeholders (no live execution).",
    status: "Reserved",
    items: [
      { label: "MT5 Control Center", description: "MT5 control center placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Terminal Status", description: "Terminal status placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "EA Bridge", description: "EA bridge placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Broker Connections", description: "Broker connections placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Account Sync", description: "Account sync placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Symbol Sync", description: "Symbol sync placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Market Watch", description: "Market watch placeholder.", plannedFeatures: defaultPlannedFeatures },
      { label: "Chart Control", description: "Chart control placeholder.", plannedFeatures: defaultPlannedFeatures },
